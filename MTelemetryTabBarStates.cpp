...
//enum EResultOpenFile { ok, corrupted, otherVersion }

//============================================================================================
MTelemetryTabBarStates::MTelemetryTabBarStates(QWidget *parent) :
                        QTabBar(parent)
{
...
//--------------------------------------------------------------------------------------------
void MTelemetryTabBarStates::mousePressEvent(QMouseEvent* event)
{
