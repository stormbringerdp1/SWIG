...
//  pSplitter->addWidget(pSplitterReadiness);
//  QList<int> list;  list << 500 << 1000;    pSplitter->setSizes(list);   list.clear();

//===  1) ReadinessTest:

//    scrollArea = new QScrollArea(centralWidget);
  QScrollArea* pScrollAreaTest = new QScrollArea(this);
...
//addWidget(pScrollAreaTest);
  ...
  QWidget* pScrollAreaTestContents = new QWidget(this);
...
//===  2) ReadinessStart:
  ...
  QScrollArea* pScrollAreaStart = new QScrollArea(this);
...
//addWidget(pScrollAreaStart);
  ...
  QWidget* pScrollAreaStartContents = new QWidget(this);
...
//  list << 700 << 200;    pSplitterReadiness->setSizes(list);
  addWidget(pScrollAreaTest);
  addWidget(pScrollAreaStart);
  QList<int> list;    list << 700 << 200;    setSizes(list);
