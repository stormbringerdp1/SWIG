...
//  PProgressBarTest1->setGeometry(QRect(110, yTopChannel+20, 91, 6));
...
//  pLabelPixmapChannel->setPixmap(QPixmap(QString::fromUtf8(namePixmapFileChannel)));
...
//                                           SIGNAL(SignalResultTest(float)), SLOT(SlotResultTest(float)));
  ...
  connect(this, SIGNAL(SignalTest(QString*,QString*,QString*,QString*)), GetPMainWnd()->GetPArduino(), SLOT(SlotTest(QString*,QString*,QString*,QString*)));
  connect(GetPMainWnd()->GetPArduino(), SIGNAL(SignalResultTest(float)), this, SLOT(SlotResultTest(float)));
...
//  GetPMainWnd()->DestroyArduinoObject();
  if(!disconnect(this, SIGNAL(SignalTest(QString*,QString*,QString*,QString*)), GetPMainWnd()->GetPArduino(), SLOT(SlotTest(QString*,QString*,QString*,QString*)))) {
    QMessageBox msgBox(QMessageBox::Warning, "void MReadinessTestChannel::SlotResultTest(float result)",
                       "Problem::\n\ndisconnect(this, SIGNAL(SignalTest(QString*,QString*,QString*,QString*)), GetPMainWnd()->GetPArduino(), SLOT(SlotTest(QString*,QString*,QString*,QString*))) == false");
      msgBox.exec();
  }
  if(!disconnect(GetPMainWnd()->GetPArduino(), SIGNAL(SignalResultTest(float)), this, SLOT(SlotResultTest(float)))) {
    QMessageBox msgBox(QMessageBox::Warning, "void MReadinessTestChannel::SlotResultTest(float result)",
                       "Problem::\n\ndisconnect(GetPMainWnd()->GetPArduino(), SIGNAL(SignalResultTest(float)), this, SLOT(SlotResultTest(float))) == false");
      msgBox.exec();
  }
